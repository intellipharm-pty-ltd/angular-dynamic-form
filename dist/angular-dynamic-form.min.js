...
// get submit steps
var a=_.isUndefined(b.submit_steps)?this.default_submit_steps:b.submit_steps;b.is_submitting=!0,
// call submit service
h.handleSubmit(a,b.model,b.form_config).then(
// complete
function(a){b.has_submitted=!0,
// custom complete handler
_.isUndefined(b.onSubmitComplete)||b.onSubmitComplete(a),b.is_submitting=!1},
// error
function(a){b.has_submitted=!0,
// custom error handler
_.isUndefined(b.onError)||b.onError(a)},
// updates (messaging)
function(a){
