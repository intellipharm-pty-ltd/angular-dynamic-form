...
// get submit steps
var a=_.isUndefined(b.submit_steps)?this.default_submit_steps:b.submit_steps;
// call submit service
// complete
// error
// updates (messaging)
return b.is_submitting=!0,h.handleSubmit(a,b.model,b.form_config).then(function(a){b.has_submitted=!0,
// custom complete handler
_.isUndefined(b.onSubmitComplete)||b.onSubmitComplete(a),b.is_submitting=!1},function(a){b.has_submitted=!0,
// custom error handler
_.isUndefined(b.onError)||b.onError(a)},function(a){
...
// if groups
// transform group fields
return _.isNull(b.model)?!0:(b.fields_array=f.transformFields(b.fields,b.form_config,b.model),void(b.has_groups&&(b.grouped_fields_array=f.transformGroupFields(b.fields_array,b.groups_config))))},
/////////////////////////////////////////////////////
//
// messaging
//
...
return h.handleSubmitSteps(0,b,c,d,f),e.promise},/**
         ...
         * @param handlers
         */
this.handleSubmitSteps=function(a,b,c,d,e,k){
// step is out of range
// default
// step is out of range
// resolve
// rejection
return a=_.isUndefined(a)?0:a,a>=b.length?void i(e,k):void h.handleSubmitStep(a,b,c,d).then(function(i){
// redefined model & form config
_.has(i,"model")&&(c=i.model),_.has(i,"form_config")&&(d=i.form_config),g=i,f="success",j("success",i,a,b,d,e),h.handleSubmitSteps(++a,b,c,d,e,i)},function(h){
// redefined model & form config
_.has(h,"model")&&(c=h.model),_.has(h,"form_config")&&(d=h.form_config),g=h,f="success",j("error",h,a,b,d,e),i(e,h)})};var i=function(a,b){
// call complete handler
_.isNull(a.submit_complete)||a.submit_complete(b)},j=function(a,b,c,d,e,f){
...
// sort (by group_order)
return _.forEach(a,function(a){var d=1;_.forEach(b,function(b){_.forEach(b.fields,function(e,f){if(e===a.name){
// clone field
var g=_.clone(a);
// add field group properties
g.group_label=b.label,_.has(b,"order")&&(d=b.order),g.group_order=d,g.order=f,
// add to array
c.push(g)}
// sort (by order)
...
return f.hide_label?f.label="":_.has(f,"label")||(f.label=j(b,e.label_camelcase,e.label_replace_underscores)),f.name=b,f.model=_.has(a,"model")?a.model:null,f.validate=!1,f},j=function(a,b,c){
// replace underscores
// camelcase
