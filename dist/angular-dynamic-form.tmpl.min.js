...
// if groups
if(b.fields_array&&b.fields_array.length>0?_.merge(b.fields_array,a):b.fields_array=a,b.has_groups){
// transform group fields
var c=f.transformGroupFields(b.fields_array,b.groups_config);b.grouped_fields_array&&b.grouped_fields_array.length>0?(_.remove(b.grouped_fields_array,function(a){return-1===_.indexOf(_.map(c,"name"),a.name)}),_.merge(b.grouped_fields_array,c)):b.grouped_fields_array=c}},
/////////////////////////////////////////////////////
//
// messaging
//
