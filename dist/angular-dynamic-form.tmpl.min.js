...
// if groups
if(b.fields_array&&b.fields_array.length>0?(_.remove(b.fields_array,function(b){return _.indexOf(_.map(a,"name"),b.name)===-1}),_.forEach(a,function(a,c){c>=b.fields_array.length?b.fields_array[c]=a:a.name!==b.fields_array[c].name?b.fields_array[c]=a:_.merge(b.fields_array[c],a)})):b.fields_array=a,b.has_groups){
// transform group fields
var c=f.transformGroupFields(b.fields_array,b.groups_config);b.grouped_fields_array&&b.grouped_fields_array.length>0?(_.remove(b.grouped_fields_array,function(a){return _.indexOf(_.map(c,"name"),a.name)===-1}),_.forEach(c,function(a,c){c>=b.grouped_fields_array.length?b.grouped_fields_array[c]=a:a.name!==b.grouped_fields_array[c].name?b.grouped_fields_array[c]=a:_.merge(b.grouped_fields_array[c],a)})):b.grouped_fields_array=c}},
/////////////////////////////////////////////////////
//
// messaging
//
...
_.has(i,"model")&&(c=i.model),_.has(i,"form_config")&&(d=i.form_config),g=i,f="success",
// send update
k("success",i,a,b,d,e),
// continue...
h.handleSubmitSteps(++a,b,c,d,e,i)},function(h){
// redefined model & form config
_.has(h,"model")&&(c=h.model),_.has(h,"form_config")&&(d=h.form_config),g=h,f="success",
// send update
k("error",h,a,b,d,e),j(e,h)})};var i=function(a,b){
...
h=_.isUndefined(f)?d(e):d.apply(f,e)}catch(a){throw console.log(a),new Error(b)}if(_.isUndefined(h))throw new Error(c);
// if method response is boolean value
if(h===!1||h===!0)h?a():g();else try{h.then(a,g)}catch(a){
// not a promise
// not a promise
throw a instanceof TypeError?new Error(c):(console.log(a),new Error(b))}})}};a.$inject=["$q","MESSAGE_EXTERNAL_METHOD_ERROR","MESSAGE_EXTERNAL_METHOD_INVALID_RETURN"],angular.module("AngularDynamicForm").service("AngularDynamicForm.helpers.ExternalCallService",a)}(),function(){"use strict";
//----------------------------------
// Validation Service
//----------------------------------
var a=function(a,b){/**
...
// update model
_.set(a.model,a.field.name,this.field_value),
// external handler
...
"map"===a.field.format&&"multi_select"===a.field.type&&_.forEach(a.field.options,function(b){_.set(a.model,b.value,_.indexOf(this.field_value,b.value)>=0)}),
// update model
_.set(a.model,a.field.name,this.field_value),
// external handler
