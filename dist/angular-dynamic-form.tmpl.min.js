...
// if groups
if(b.fields_array&&b.fields_array.length>0?(_.remove(b.fields_array,function(b){return-1===_.indexOf(_.map(a,"name"),b.name)}),_.forEach(a,function(a,c){c>=b.fields_array.length?b.fields_array[c]=a:a.name!==b.fields_array[c].name?b.fields_array[c]=a:_.merge(b.fields_array[c],a)})):b.fields_array=a,b.has_groups){
// transform group fields
